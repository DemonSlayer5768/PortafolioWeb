...
function J() {
  ...
  (v.constructor = y), S(v, _.prototype), (v.isPureReactComponent = !0);
  var O = Array.isArray,
  ...
  function l(t, e, n, r, s) {
        ...
        case "object":
          switch (t.$$typeof) {
            ...
            case M:
              ...
              break;
            case C:
              return (u = t._init), l(u(t._payload), e, n, r, s);
          }
      }
    if (u)
      return (
    ...
    if (O(t))
      for (var c = 0; c < t.length; c++)
        (r = t[c]), (f = a + T(r, c)), (u += l(r, e, n, f, s));
    else if (((c = z(t)), typeof c == "function"))
      for (t = c.call(t), c = 0; !(r = t.next()).done; )
        (r = r.value), (f = a + T(r, c++)), (u += l(r, e, n, f, s));
    else if (f === "object") {
      if (typeof t.then == "function") return l(B(t), e, n, r, s);
      throw (
        ((e = String(t)),
        Error(
